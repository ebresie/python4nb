...
import org.apache.netbeans.modules.python4nb.project.PythonProjectType;
...
public class Utils {
    ...
    public static String chooseMainModule(PythonProject project) {
    ...
    private static class EditMediator implements ActionListener,
            ListSelectionListener, CellEditorListener, SourceRootsMediator {
